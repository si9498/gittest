...
<body>
<form action="../join-view" name="form" method="post">
 <table class="container">
  <tr>
   ...
   <br>
   <textarea rows="20" cols="150" disabled>
제1조(목적) 이 약관은 OO 회사(전자상거래 사업자)가 운영하는 OO 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리ㆍ의무 및 책임사항을 규정함을 목적으로 합니다.
...
제3조 (약관 등의 명시와 설명 및 개정) 
  ...
  ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호ㆍ모사전송번호ㆍ전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 00 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
제7조(회원 탈퇴 및 자격 상실 등) 
  ...
  ③ “몰”이 회원 자격을 제한ㆍ정지 시킨 후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 “몰”은 회원자격을 상실시킬 수 있습니다.
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
   ...
   <td align="center" valign="top">
    <button type="button" onclick="chk()" class="btn btn-outline-success">동의</button> &nbsp;&nbsp;&nbsp;
    <button type="button" onclick="nochk()" class="btn btn-outline-success">동의 안함</button>    
   </td>
  </tr>
 </table>
</form>

...
public class FreeController {
	...
	public String fList(HttpServletRequest request, SearchVO searchVo, Model model) {
	...
	public String fwrite(HttpServletRequest request, Model model) throws Exception {
...
//		String path=uploadPath+attachPath;
	...
	public String fcontent_view(HttpServletRequest request, Model model) {
	...
	public String fmodify_view(HttpServletRequest request, Model model) {

...
public class InformController {
	...
	public String iList(HttpServletRequest request,SearchVO searchVo, Model model) {
	...
	public String iwrite(HttpServletRequest request,Model model) throws Exception {
		...
		path=path.substring(1, path.indexOf(".metadata"))
				+"Project_UDB0520/src/main/webapp/resources/upload";
	...
	public String icontent_view(HttpServletRequest request,Model model) {
	...
	public String imodify_view(HttpServletRequest request,Model model) {
